...
<body>
    <div class="container">
        <h1>Методы оплаты</h1>
        <p>Мы принимаем различные методы оплаты для вашего удобства.</p>
        <h2>Доступные методы оплаты</h2>
        <p>Вы можете оплатить нашими услугами или товарами с помощью следующих методов:</p>
        <ul>
            <li>Банковские карты (Visa, MasterCard)</li>
            <li>Электронные кошельки (Яндекс.Деньги, QIWI)</li>
            <li>Банковские переводы</li>
        </ul>
        <div class="form-text mt-4">
            <p>Вернуться на <a href="login.php">страницу авторизации</a></p>
        </div>
    </div>
